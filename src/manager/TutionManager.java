...
public class TutionManager {
    ...
    /**
     * The method checks if the credits entered match the number of credits based on residency status.
            ...
            try {
                if ( inputText.equals("") ) {
                    ...
                    System.exit(ZERO);
                        ...
                        inputText.equals("P") || inputText.equals("PS") ||  inputText.equals("SE") || inputText.charAt(ZERO) == 'E' ||
