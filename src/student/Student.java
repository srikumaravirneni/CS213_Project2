...
public abstract class Student implements Comparable<Student> {
    ...
    private final int creditCompleted;
    ...
    public boolean isValid(int creditEnrolled) {
        return this.creditCompleted >= 3 && this.creditCompleted <= 24;
    }
    ...
    /**
     * student status abstract class to get student status.
     */
    ...
    /**
     * polymorphism method for resident status.
     */
